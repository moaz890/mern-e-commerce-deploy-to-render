...
export const getAllOrdersForAdmin = createAsyncThunk('order/getOrdersForAdmin', async () => {
    const response = await axios.get(`https://mern-e-commerce-deploy-to-render.vercel.app/api/admin/order/get`);
    return response.data;
});

export const getOrdersDetailsForAdmin = createAsyncThunk('order/getOrderDetailsForAdmin', async (id) => {
    const response = await axios.get(`https://mern-e-commerce-deploy-to-render.vercel.app/api/admin/order/details/${id}`);
...
export const updateOrderStatus = createAsyncThunk("ordre/updateOrderStatus", async ({id, orderStatus}) => {
    const response = await axios.put(`https://mern-e-commerce-deploy-to-render.vercel.app/api/admin/order/update/${id}`, {orderStatus});
    return response.data;
})
